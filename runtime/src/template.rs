...
decl_module! {
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        pub fn call_contract(origin, address: T::AccountId, selector: Vec<u8>, flag: bool, val: u32) -> DispatchResult {
            let who = ensure_signed(origin)?;
        ...
        pub fn get_contract_storage(origin, address: T::AccountId) -> DispatchResult {
            let _who = ensure_signed(origin)?;
